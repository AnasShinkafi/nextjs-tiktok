    ...
    <>
        <div id={`PostMain-${post.id}`} className=" flex border-b py-6">
            ...
            <div className=" pl-3 w-full px-4">
                ...
                <p className="text-[15px] pb-0.5 break-words md:max-w-[400px] max-w-[300]">{post.text}</p>
                <p className=" text-[14px] text-gray-500 pb-0.5">#fun #cool #SuperAwesome</p>
                <p className=" text-[14px] flex pb-0.5 items-center font-semibold">
                    <ImMusic size="17" />
                ...
                <div className=" mt-2.5 flex">
                    <div className=" relative min-h-[480px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
                        <video 
                            ...
                            controls
                            muted
                            className=" rounded-xl object-contain mx-auto h-full"
                            src={useCreateBucketUrl(post?.video_url)}
                        />

                        <img src="/images/tiktok-logo-white.png" alt="" className=" absolute right-2 bottom-10"  width={90}/>
                    </div>
