...
const useChangeUserImage  = async (file: File, cropper: any, currentImage: string) => {
    ...
    try {
        ...
        const cropperImage = image.crop({ x, y, width, height });
        const resizedImage = cropperImage.resize({ width: 200, height: 200 });
        ...
        if (currentImage != String(process.env.NEXT_PUBLIC_PLACEHOLDER_DEAFAULT_IMAGE_ID)) {
